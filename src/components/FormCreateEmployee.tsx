...
import { MaModale } from 'react-confirm-modal-v1' // Import de mon module de NPM
...
export const FormCreateEmployee = () => {
   ...
   */
  const handleChangeDataEmployee = (
  ...
  // Styles personnalisés pour le conteneur de la modale
  const customModalContainerStyles = {
    backgroundColor: 'gold',
    borderRadius: '0.5rem',
    maxHeight: '300px',
    // Ajoutez d'autres styles personnalisés si besoin
  };
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full m-auto mt-4">
      ...
      <MaModale
        ...
        // Utilisation d'un style personnel
        customStyles={{ containerStyles: customModalContainerStyles }}
      />
    </div>
  );
}